...
while($r = mysqli_fetch_array($q)){
	...
	?>
		<tr>
			...
			<td>
				<a onclick="modificar('<?=$r['id']?>')" href="#"><button class="btn btn-primary" type="submit" name="modificar">Modificar</button></i></a>
				<a href="?p=carrito&eliminar=<?=$r['id']?>"><button class="btn btn-danger" type="submit" name="finalizar">Eliminar</button></a>
			</td>
		</tr>
	<?php
}
