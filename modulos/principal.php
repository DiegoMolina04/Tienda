...
while($r=mysqli_fetch_array($q)){
	...
	?>
		<div class="producto">
			...
			<button class="btn btn-warning pull-right" onclick="agregar_carro('<?=$r['id']?>');">Comprar</button>
		</div>
	<?php
}
?>
...
<?php
	...
	?>
		<div class="producto">
			...
			<del><?=$r['price']?> <?=$divisa?></del> <span class="precio"> <?=$preciototal?> <?=$divisa?> </span>
			<button class="btn btn-warning pull-right" onclick="agregar_carro('<?=$r['id']?>');">Comprar</i></button>
		</div>
	<?php
}
?>
